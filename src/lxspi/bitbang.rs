...
pub type R = crate::R<u32, super::BITBANG>;
#[doc = "Writer for register BITBANG"]
pub type W = crate::W<u32, super::BITBANG>;
...
impl R {
    #[doc = "Bit 0 - MOSI output pin, valid whenever `dir` is `0`."]
    #[inline(always)]
    pub fn mosi(&self) -> MOSI_R {
        MOSI_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - Output value for SPI CLK line."]
    #[inline(always)]
    pub fn clk(&self) -> CLK_R {
        CLK_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - Output value of SPI CSn line."]
    #[inline(always)]
    pub fn cs_n(&self) -> CS_N_R {
        CS_N_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - Dual/Quad SPI reuses pins SPI pin direction."]
    #[inline(always)]
